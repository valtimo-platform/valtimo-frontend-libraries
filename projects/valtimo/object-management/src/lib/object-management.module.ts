...
import {ObjectManagementEditModalComponent} from './components/object-management-edit-modal/object-management-edit-modal.component';
...
@NgModule({
  declarations: [
    ...
    ObjectManagementEditModalComponent,
