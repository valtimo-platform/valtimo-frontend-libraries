...
@Component({
  selector: 'valtimo-delete-script-modal',
  templateUrl: './delete-script-modal.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DeleteScriptModalComponent {
