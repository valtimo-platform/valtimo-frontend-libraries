  ...
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  ...
  @Input() prefillConfiguration$: Observable<BesluitenApiConfig>;
  ...
  private readonly formValue$ = new BehaviorSubject<BesluitenApiConfig | null>(null);
  ...
  formValueChange(formValue: BesluitenApiConfig): void {
    this.formValue$.next(formValue);
    this.handleValid(formValue);
  }

  private handleValid(formValue: BesluitenApiConfig): void {
    const valid = !!(
