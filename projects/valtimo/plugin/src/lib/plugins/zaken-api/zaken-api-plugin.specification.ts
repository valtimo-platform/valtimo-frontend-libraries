...
const zakenApiPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      zaakObjectZaakUrl: 'Zaak URL',
      zaakObjectZaakUrlTooltip: 'URL-referentie naar de ZAAK. Waneer dit veld leeg is, zal de zaak die aan de proces instance hangt gebruikt worden.',
      zaakObjectObjectUrl: 'Object URL',
      zaakObjectObjectUrlTooltip: 'URL-referentie naar de resource die het OBJECT beschrijft.',
      zaakObjectType: 'Zaak object type',
      zaakObjectTypeTooltip: 'URL-referentie naar het ZAAKOBJECTTYPE (in de Catalogi API).',
    ...
    en: {
      ...
      zaakObjectZaakUrl: "Case URL",
      zaakObjectZaakUrlTooltip: "URL reference to the ZAAK. When this field is empty, the case linked to the process instance will be used.",
      zaakObjectObjectUrl: "Object URL",
      zaakObjectObjectUrlTooltip: "URL reference to the resource that describes the OBJECT.",
      zaakObjectType: "Case object type",
      zaakObjectTypeTooltip: "URL reference to the ZAAKOBJECTTYPE (in the Catalog API).",
      objectType: "Object Type",
    ...
    de: {
      ...
      zaakObjectZaakUrl: "Vorgangs-URL",
      zaakObjectZaakUrlTooltip: "URL-Referenz zum ZAAK. Wenn dieses Feld leer ist, wird der Vorgang verwendet, der mit der Prozessinstanz verknüpft ist.",
      zaakObjectObjectUrl: "Objekt-URL",
      zaakObjectObjectUrlTooltip: "URL-Referenz zur Ressource, die das OBJECT beschreibt.",
      zaakObjectType: "Vorgangsobjekttyp",
      zaakObjectTypeTooltip: "URL-Referenz zum ZAAKOBJECTTYPE (in der Catalogi-API).",
