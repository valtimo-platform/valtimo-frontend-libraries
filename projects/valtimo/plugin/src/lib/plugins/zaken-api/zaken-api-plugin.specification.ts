...
const zakenApiPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      paymentIndication: 'Betalingsindicatie (nvt, nog niet, gedeeltelijk, geheel)',
      lastPaymentDate: 'Laatste betaaldatum',
      caseGeometry: 'Zaakgeometrie',
      caseGeometryType: 'Zaakgeometrie type',
      caseGeometryCoordinates: 'Zaakgeometrie coordinaten',
      mainCase: 'Hoofdzaak',
    ...
    en: {
      ...
      paymentIndication: 'Payment indication (nvt, nog niet, gedeeltelijk, geheel)',
    ...
    de: {
      ...
      paymentIndication: 'Zahlungsanzeige (nvt, nog niet, gedeeltelijk, geheel)',
