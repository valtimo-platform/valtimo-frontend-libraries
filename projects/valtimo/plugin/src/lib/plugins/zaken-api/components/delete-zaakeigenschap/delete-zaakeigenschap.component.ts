...
import {InputOption, DeleteZaakeigenschapConfig} from '../../models';
  ...
  implements FunctionConfigurationComponent, OnInit, OnDestroy
{
  ...
  @Input() prefillConfiguration$: Observable<DeleteZaakeigenschapConfig>;
  @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() configuration: EventEmitter<DeleteZaakeigenschapConfig> =
    new EventEmitter<DeleteZaakeigenschapConfig>();
  ...
  private readonly formValue$ = new BehaviorSubject<DeleteZaakeigenschapConfig | null>(null);
