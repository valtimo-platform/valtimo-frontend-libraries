  ...
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  ...
  private readonly formValue$ = new BehaviorSubject<OpenNotificatiesConfig | null>(null);
  ...
  formValueChange(formValue: OpenNotificatiesConfig): void {
    this.formValue$.next(formValue);
    this.handleValid(formValue);
  }

  private handleValid(formValue: OpenNotificatiesConfig): void {
