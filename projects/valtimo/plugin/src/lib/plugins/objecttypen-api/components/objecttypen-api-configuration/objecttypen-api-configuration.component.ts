...
export class ObjecttypenApiConfigurationComponent
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  @Input() save$: Observable<void>;
  @Input() disabled$: Observable<boolean>;
  @Input() pluginId: string;
  @Input() prefillConfiguration$: Observable<ObjecttypenApiConfig>;
  ...
  private readonly formValue$ = new BehaviorSubject<ObjecttypenApiConfig | null>(null);
  ...
  private handleValid(formValue: ObjecttypenApiConfig): void {
    const valid = !!(
