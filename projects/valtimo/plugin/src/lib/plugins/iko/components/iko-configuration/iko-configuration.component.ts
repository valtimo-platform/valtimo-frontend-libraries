...
@Component({
  standalone: false,
  selector: 'valtimo-iko-configuration',
...
export class IkoConfigurationComponent implements PluginConfigurationComponent, OnInit, OnDestroy {
  ...
  @Input() prefillConfiguration$: Observable<IkoConfig>;
  @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() configuration: EventEmitter<IkoConfig> = new EventEmitter<IkoConfig>();
  ...
  private handleValid(formValue: IkoConfig): void {
