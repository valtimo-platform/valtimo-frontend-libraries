...
@Component({
  ...
  templateUrl: './dossier-management-tags.component.html',
  styleUrls: ['./dossier-management-tags.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DossierManagementTagsComponent implements AfterViewInit {
  ...
  public readonly documentStatuses$ = combineLatest([
    ...
    map(statuses =>
      statuses.map(status => ({
        ...status,
        tagType: TagsUtils.getTagTypeFromTagsColor(status.color),
      }))
    ),
    tap(statuses => {
