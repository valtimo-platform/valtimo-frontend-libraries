...
import {BehaviorSubject, combineLatest, Observable, of, startWith, Subscription, switchMap} from 'rxjs';
import {
  ...
  implements FormioCustomComponent<Array<DocumentenApiFileReference>>, OnInit, OnDestroy
{
  ...
  readonly uploadProcessLinked$: Observable<boolean | string> = this.modalService.documentDefinitionName$.pipe(
