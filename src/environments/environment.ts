    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          {link: ['/decision-tables'], title: 'Decision tables', sequence: 2},
          {link: ['/dossier-management'], title: 'Dossiers', sequence: 3},
          {link: ['/building-block-management'], title: 'Building blocks', sequence: 4},
          {link: ['/task-management'], title: 'Tasks', sequence: 5},
          {
